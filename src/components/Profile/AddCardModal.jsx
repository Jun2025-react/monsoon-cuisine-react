...
const AddCardModal = ({ user, show, handleClose, refreshCards }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const result = await addCard(payload);  // send to your backend
            console.log("Card added successfully", result);
            handleClose();
        } catch (err) {
            console.error("Error sending card to backend:", err);
        }
    };
        ...
        <Modal show={show} onHide={handleClose}>
            ...
            <Form onSubmit={handleSubmit}>
                ...
                <Modal.Footer>
                    ...
                    <Button variant="primary" type="submit" disabled={!stripe}>Add Card</Button>
                </Modal.Footer>
            </Form>
        </Modal>
